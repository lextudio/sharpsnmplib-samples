...
Module Program
    Public Sub Main(ByVal args As String())
        If args.Length = 0 Then
            ...
            Using engine As SnmpEngine = New SnmpEngine(New Listener() With {.Users = users}, New EngineGroup(idEngine), store, membership, AddressOf Program.WatcherTrapV1Received, AddressOf Program.WatcherTrapV2Received, AddressOf Program.WatcherInformRequestReceived)
    ...
    Private Sub WatcherInformRequestReceived(ByVal e As InformRequestMessageReceivedEventArgs)
        Console.WriteLine(e.InformRequestMessage)
    End Sub

    Private Sub WatcherTrapV2Received(ByVal e As TrapV2MessageReceivedEventArgs)
        Console.WriteLine(e.TrapV2Message)
    End Sub

    Private Sub WatcherTrapV1Received(ByVal e As TrapV1MessageReceivedEventArgs)
